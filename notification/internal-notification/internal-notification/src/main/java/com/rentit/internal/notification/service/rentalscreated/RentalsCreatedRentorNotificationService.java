...
@Service
public class RentalsCreatedRentorNotificationService implements RentalsCreatedNotificationService {
  ...
  public InternalNotificationModel createNotificationModel(RentalCreatedEvent event) {
    ...
    internalNotificationModel.setMessage("Test message rentor");
