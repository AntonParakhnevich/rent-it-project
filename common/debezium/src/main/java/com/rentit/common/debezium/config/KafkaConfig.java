...
public class KafkaConfig {
  ...
  @Bean
  public KafkaProducer<String, Event> kafkaProducer(ObjectMapper objectMapper) {
    ...
    return new KafkaProducer<>(props, new StringSerializer(), kafkaJsonSerializer(objectMapper));
  }

  @Bean
  public KafkaJsonSerializer kafkaJsonSerializer(ObjectMapper objectMapper) {
